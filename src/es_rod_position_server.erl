...
%% @end
%%-------------------------------------------------------------------
params() -> [{ctrl_pos_cntr, control_position_counter}, {sd_pos_cntr, shutdown_position_counter}]. % , {ctrl_pos, control_position}, {ctrl_pos_array, control_position_array_str}, {sd_pos, shutdown_position}
